export const metadata= {
    title: "About | Front-end insights",
    description: "Rodrigo-a front-end insights é uma newletter semanaal dedicada a fornecer conhecimentos valiosos sobre o mundo do desenvolvimento front-end",
    
    openGraph:{
    tittle: "sobre | Front-end Insights",
    description: "Rodrigo-a front-end insights é uma newletter semanaal dedicada a fornecer conhecimentos valiosos sobre o mundo do desenvolvimento front-end",
